    ...
    <div style={{ marginBottom: 2 }}>
      ...
      >
        <div className="factor-bar-inner" style={{ display: "flex", alignItems: "center", gap: 12 }}>
          ...
          <div className="factor-score" style={{ width: 48, textAlign: "right", fontFamily: T.font, fontSize: 13, fontWeight: 600, color: barColor }}>
            {factor.score >= 0 ? "+" : ""}{factor.score.toFixed(2)}
          </div>
          <div className="factor-weighted" style={{ width: 48, textAlign: "right", fontFamily: T.font, fontSize: 11, color: weightedColor, opacity: 0.7 }}>
      ...
      {isExpanded && factor.signals && (
        <div className="factor-expand-content" style={{ padding: "8px 12px 12px", background: T.inset, borderTop: `1px solid ${T.border}`, margin: "0 8px 8px", borderRadius: T.radius }}>
  ...
  return (
    <>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
        <div>
          <div className="spy-price" style={{ fontSize: 32, fontWeight: 700 }}>
...
export default function App() {
  ...
  return (
    <div style={{ background: T.bg, color: T.text, minHeight: "100vh", fontFamily: T.font }}>
      {/* ── Header ── */}
      <div className="header-bar" style={{ borderBottom: `1px solid ${T.border}`, padding: "0.5rem 1.5rem", background: T.panel, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      <div className="dashboard-grid" style={{ padding: "1.5rem", display: "grid", gridTemplateColumns: "320px 1fr 280px", gap: "1.5rem", maxWidth: 1440, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
          ...
          <Panel title="Composite Signal" tag={Object.values(factors).some((f) => f.score === 0) ? `${Object.values(factors).filter((f) => f.score !== 0).length}/${Object.keys(factors).length} ACTIVE` : undefined}>
            <div style={{ textAlign: "center" }}>
              <div className="score-display" style={{ fontSize: 56, fontWeight: 700, color: compositeColor, lineHeight: 1, marginBottom: 6 }}>
        ...
        <div className="dashboard-right" style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
